        ...
        try {
            ...
            if (jobs.length === 0) {
                container.innerHTML = `
                    <div class="empty-state">
                        ...
                        <a href="../pages/jobs.html" class="btn btn-apply" style="display:inline-flex; width:auto; margin:20px auto;">Browse Jobs</a>
                    </div>
                `;
                return;
            }
            ...
            container.innerHTML = jobs.map(job => `
                <div class="job-card" id="job-${job.job_id}">
                    ...
                    <div class="actions">
                        <a href="../pages/apply_home.html?job_id=${job.job_id}&title=${encodeURIComponent(job.job_title)}&company=${encodeURIComponent(job.company_name)}&location=${encodeURIComponent(job.location || 'Remote')}&type=${encodeURIComponent(job.job_type || 'Full Time')}" class="btn btn-apply">Apply Now</a>
