    ...
    if (applyBtn) {
        applyBtn.addEventListener("click", () => {
            const filters = {
                ...
                job_type: Array.from(document.querySelectorAll('input[name="job_type"]:checked')).map(c => c.value)[0] || "",
                work_mode: Array.from(document.querySelectorAll('input[name="work_mode"]:checked')).map(c => c.value)[0] || ""
            };
