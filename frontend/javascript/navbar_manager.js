    ...
    menus.forEach(menu => {
        ...
        if (isEmployer || isAdmin) {
            ...
            if (!hasLinkTo(links, "my_applications.html")) {
                ...
                appsLi.innerHTML = `<a href="${prefix}frontend/pages/my_applications.html" class="nav-link"><i class="fas fa-file-alt"></i> ${isAdmin ? 'All Applicants' : 'Received Apps'}</a>`;
            ...
            if (isAdmin && !hasLinkTo(links, "dashboard.html")) {
                ...
                dashLi.innerHTML = `<a href="${prefix}frontend/pages/dashboard.html" class="nav-link"><i class="fas fa-columns"></i> Dashboard</a>`;
            ...
            if (!hasLinkTo(links, "postjob_home.html")) {
                ...
                postJobLi.innerHTML = `<a href="${prefix}frontend/pages/postjob_home.html" class="nav-link" style="color:#16a34a;font-weight:700;"><i class="fas fa-plus-circle"></i> Post Job</a>`;
            ...
            if (!hasLinkTo(links, "saved_jobs.html")) {
                ...
                savedLi.innerHTML = `<a href="${prefix}frontend/pages/saved_jobs.html" class="nav-link" title="Saved Jobs"><i class="fas fa-bookmark"></i></a>`;
                menu.insertBefore(savedLi, profileLink.parentElement);
            }

            if (!hasLinkTo(links, "my_applications.html")) {
                const appsLi = document.createElement("li");
                appsLi.innerHTML = `<a href="${prefix}frontend/pages/my_applications.html" class="nav-link"><i class="fas fa-file-alt"></i> My Applications</a>`;
                menu.insertBefore(appsLi, profileLink.parentElement);
            }
        }
